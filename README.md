...
경북대학교 컴퓨터학부의 공지사항과 인재모집 게시판을 15분마다 자동으로 확인하여, 새로운 글이 올라오면 **텔레그램(Telegram)**으로 즉시 알림을 보내주는 봇입니다.
...
- **Telegram 연동**: 카카오톡 API의 번거로움(토큰 갱신)을 해결하기 위해 텔레그램 봇 API를 사용했습니다.

## Tech Stack
- **Language**: Python 3.12
- **Crawling**: BeautifulSoup4, Requests
- **Infra**: GitHub Actions (Serverless Automation)
- **Notification**: Telegram Bot API

## How to Run
이 프로젝트는 GitHub Actions에서 자동으로 실행되지만, 로컬에서 테스트하려면 아래와 같이 실행하세요.
